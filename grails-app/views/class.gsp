...
<div ng-controller="classController" ng-cloak>
    ...
    <!-- Grid System -->
    <div class="hvr-grow-2 row" style="margin-left: auto; margin-right: auto; border-radius: 20px; box-shadow: 8px -8px 0 rgba(32, 152, 209, 0.6); background-color: rgba(32, 152, 209, 0.3)">
