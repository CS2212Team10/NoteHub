...
<div style="width:300px; text-align:center; margin:0 auto; padding:0; border:0px solid #000; font-size:12pt;" ng-controller ="CreateCircleController">
    ...
    <h3 style="margin:0 auto 20px auto; width:175px;">Create New Circle</h3>
    ...
    <form ng-submit="uploadCircle(circleInfo)">
        ...
        <a style="border:0; width:275px; height:30px; background-color:#3399FF; color:#FFF;" class="btn" href="/home?user={{userId}}" class="btn">
            cancel
        </a>​
    </form>
