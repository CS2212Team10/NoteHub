...
<head>
    ...
    <title> NoteHub - Create Circle</title>
</head>
<style>
...
<div class="hvr-grow-2" style="border-radius: 20px; box-shadow: 8px -8px 0 rgba(32, 152, 209, 0.6); background-color: rgba(32, 152, 209, 0.3); width:300px; text-align:center; margin:0 auto; padding:0; border:0px solid #000; font-size:12pt;" ng-controller ="CreateCircleController">
    <br>
    <h3 class="a" style="text-shadow: 1px -1px 2px rgba(0,0,0,0.5); margin:0 auto 20px auto; margin-top: 10px; width:175px; font-size: 25px">Create Circle</h3>

    <p style="margin:0 auto; width:275px; text-align:left;">Title</p>
    <!-- TODO fix texts -->
    <form ng-submit="uploadCircle(circleInfo)">
        <input class="hvr-glow" style="padding: 2px; width:275px; margin:0 auto;"  type="text" name="Note Name" value="" placeholder="ex: Class 2212B" ng-model="circleInfo.name"><br>
        ...
        <input style="border:0; width:255px; height:30px; margin-bottom: 15px; background-color:#3399FF; color:#FFF;" class="hvr-grow-shadow btn" type="submit" value="Upload">
        <!--
        ...
        <a style="text-decoration:none; border:0; width:255px; height:30px; background-color:#3399FF; color:#FFF;" class="hvr-grow-shadow btn" ng-click="redirect()" class="btn">
            cancel
        </a>​
    <br>
    <br>
