...
<div class="hvr-grow-2" style="border-radius: 20px; box-shadow: 8px -8px 0 rgba(32, 152, 209, 0.6); background-color: rgba(32, 152, 209, 0.3); width:300px; text-align:center; margin:0 auto; padding:0; border:0px solid #000; font-size:12pt;" ng-controller ="CreatePostController">
    ...
    <form class="hvr-glow" method="post" enctype="multipart/form-data">
        <input style="border-radius: 5px; width:275px; margin:0 auto; padding:0;" type="text" name="Note Name" value="" placeholder="Email address" ng-model="title"><br>
    </form>
    ...
    <form class="hvr-glow" method="post" enctype="multipart/form-data">
        <input style="border-radius: 5px; width:275px; margin:0 auto; padding:0;" type="text" name="Note Name" value="" placeholder="Password" ng-model="titles"><br>
    </form>
    <br>
    <a style="text-decoration: none; margin-top: 20px; margin-bottom: 20px; border:0; width:245px; height:30px; background-color:#3399FF; color:#FFF;" href="home" class="hvr-grow-shadow btn">
            Sign In
    </a>​
